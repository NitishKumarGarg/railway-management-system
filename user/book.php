...
if(isset($_POST['submit']))
{
    ...
    $flexible=test_input($_POST['flexible']);
...
?>
        ...
        x=document.forms["adform"]["flexible"].value;
			}
		</script>
...
<br><br><br>
          ...
          <br>
          <div class="form-group">
					<label  class="col-sm-3 control-label">Flexibility Option</label>
          <div class="col-sm-8" >
					  <input type="radio"  id="flexible"  name="flexible" value=1 checked>Flexible
            <input type="radio"  id="flexible"  name="flexible" value=0 checked>Not Flexible<br>
					</div>
				  <br><br><br><br>
