...
?>
			  ...
			  <div class="col-md-12 forminput">
				<form style="margin-top:25px;" name="adform" action="" onsubmit="return validate_from()" method="post" class="form-horizontal" >
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-8">
					  <input type="date" class="form-control" id="inputdate3" placeholder="date : 2016-10-01" name="date">
					</div>
				  </div>
				  ...
				  <div class="form-group">
					<label  class="col-sm-3 control-label">Number of available seats</label>
					<div class="col-sm-8">
          ...
          <!--div class="form-group">
         <label  class="col-sm-3 control-label">Number of  waiting seats</label>
         <div class="col-sm-8">
           <input type="text" class="form-control" id="inputEmail3" placeholder="Number of seat_no" name="seat_no">
         </div>
       </div-->
