...
if(isset($_POST['submit']))
{
 ...
 $statement = $db->prepare("INSERT INTO trains (TrainNumber,TrainName,Category,Start,End,price) VALUES (?,?,?,?,?,?)");
		
	$statement->execute(array($train_id,$train_name,$train_type,$source_stn,$destination_stn,$price));
	header("location:adminhome.php");
}
?>
...
<?php include('header.php'); ?>
			...
			function validate_from()
			{
			    ...
			    x=document.forms["adform"]["price"].value;
				if(x==null || x=="")
				{
					alert("Enter Price");
					return false;
				...
				<form class="form-horizontal" name="adform" action="" onsubmit="return validate_from()" method="post">
				 ...
				 <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-8">
					  <input type="number" class="form-control" id="inputPassword3" name="price" placeholder="Price">
					</div>
				  </div>
